#!/bin/bash
#SBATCH --job-name=only_steering_at_10_20steps_best_only_fkb2_try_yes_selection_corrected
...
run_name="only_steering_at_10_20steps_best_only_fkb2_try_yes_selection_corrected"
