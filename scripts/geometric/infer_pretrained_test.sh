#!/bin/bash
#SBATCH --job-name=geometric_pretrained_new_test
...
output_dir="/home/pramish_paudel/codes/b2diff/model/lora/geometric_pretrained_test_set"   # ← change this to your desired output directory
...
python3 ./scripts/inference/run_inception_score.py --img_dir "${output_dir}/${run_name}/stage0/images/"
